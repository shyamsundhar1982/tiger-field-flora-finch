//#region node_modules/.nitro/vite/services/ssr/assets/company-BH866iCc.js
var COMPANY = {
...
var TIERS = [
	{
		...
		weight: "890 g frame*",
		pitch: "All-day geometry. T700 layup tuned for fatigue life and comfort on 200–1200 km rides.",
		highlights: [
			"T700 high-modulus",
			"ISO 4210 path",
			"Lifetime-class fatigue target"
		]
	},
	{
		id: "pro",
		...
		image: "/bikes/pro.jpg",
		weight: "820 g frame*",
		pitch: "The house bike. Stiffer front triangle, tighter stack/reach, satin carbon with titanium hardware.",
		highlights: [
			"T700/T800 mix",
			"Integrated cockpit",
			"Primary volume mix"
	...
	},
	{
		...
		weight: "760 g frame*",
		pitch: "Exposed weave, fully integrated front end, T800 primary. Built for riders who already know.",
		highlights: [
			"T800 primary",
			"Raw weave option",
			"Limited allocation"
...
//#endregion
export { TIERS as n, TRANCHES as r, COMPANY as t };
