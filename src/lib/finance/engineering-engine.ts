...
export const ENGINEERING_REVISIONS: EngineeringRevision[] = [
  { product: "Carbon / Pro", revision: "C3", status: "released", geometry: "Race endurance geometry · Rev C", material: "High-modulus carbon", layup: "C3 production layup", alloy: "—", tooling: "Carbon frame mould set C", drawing: "VX-CARBON-C3" },
  ...
  { product: "Premium Carbon / Apex", revision: "C2", status: "released", geometry: "Aero performance geometry · Rev B", material: "High-modulus carbon", layup: "C2 production layup", alloy: "—", tooling: "Apex mould set B", drawing: "VX-APEX-C2" },
];
