...
export const routeRegistry: Record<string, RouteMeta> = {
  ...
  '/command/founder-control': meta('/command/founder-control','Founder Control Upgrade','operate','command','founder','keep','Leadership & Investors'),
  ...
  '/command/stakeholder-portal': meta('/command/stakeholder-portal','Stakeholder Portal','showcase','leadership','investors','keep','Leadership & Investors'),
