...
export const FOUNDER_CONTROL_LANES = [
  { id: "cash", title: "Cash protection", owner: "Founder", route: "/command/cash", rule: "Escalate when modeled closing cash falls below the approved Operating Plan cash floor." },
...
export const FOUNDER_CONTROL_CHECKS = [
  { id: "IC-01", title: "Cash floor", severity: "critical", source: "Approved Operating Plan + Financial model", action: "Review runway and funding gate", route: "/command/cash" },
