...
export const LEGAL_CONTROLS: LegalControl[] = [
  ...
  { id: "L-07", title: "Trademark clearance", domain: "IP", status: "verify", requirement: "Clear and decide filing strategy for Vāyú Shastr, VYNDI and frozen product marks before public commercial use.", evidence: "Trademark search report + counsel opinion + filing receipt where applicable", owner: "IP Counsel", stage: "M1–M3" },
