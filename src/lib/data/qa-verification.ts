...
export const QA_CHECKS: QACheck[] = [
  ...
  { id: "QA-07", domain: "finance", title: "Financial model is labelled as planning", priority: "high", status: "pass", requirement: "ASP, COGS, breakeven and monthly cash figures are planning assumptions until CA validation.", evidence: "Finance Control + 36-month plan + Balance Sheet", nextAction: "Reconcile with CA-certified projections before funding submissions." },
