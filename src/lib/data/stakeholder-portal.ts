...
export const STAKEHOLDER_SECTIONS = [
  ...
  { id: "product", title: "Product & engineering", summary: "VAEA design language, controlled VEDM baseline, T700/T800 architecture and validation pathway.", status: "in-progress" as StakeholderStatus, route: "/command/qa-verification" },
  { id: "commercial", title: "Commercial model", summary: "Product tiers, launch sequence, unit economics and demand assumptions linked to the financial model.", status: "in-progress" as StakeholderStatus, route: "/command/investor-board" },
  { id: "manufacturing", title: "Manufacturing", summary: "Controlled OEM qualification, pilot production, QC and evidence-led release gates.", status: "in-progress" as StakeholderStatus, route: "/command/qa-verification" },
