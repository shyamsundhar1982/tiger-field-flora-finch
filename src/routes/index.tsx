    ...
    <div className="min-h-dvh bg-bg">
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="max-w-3xl">
          <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-green">Engineering doctrine</p>
          <h2 className="mt-2 text-4xl font-bold leading-tight text-accent sm:text-5xl">The Engineering Behind the Ride</h2>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2">
          ...
          <ul className="grid gap-4 text-sm">
            {[
              ...
              ["Range", "Core ₹1,31,000 · Pro ₹1,75,000 · Apex ₹3,25,000 starting ASP planning."],
      ...
      <section className="mx-auto max-w-6xl px-4 py-24 text-center sm:px-6">
        <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-green">VéLOXIS</p>
        <h2 className="mt-3 text-4xl font-bold tracking-tight text-accent sm:text-6xl">Are You Ready to Fly?</h2>
        <p className="mx-auto mt-5 max-w-3xl text-base leading-7 text-muted sm:text-lg">VÉLOXIS isn't just another brand. It is a system. An engineering philosophy that respects the rider, the material, and the road.</p>
      </section>
      <SiteFooter />
    </div>
  );
