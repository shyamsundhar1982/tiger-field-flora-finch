      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-4 py-20 sm:px-6 lg:grid-cols-3">
        {TIERS.map((t) => (
          <Link key={t.id} to="/range/$tier" params={{ tier: t.id }} className="group block">
            <div className="overflow-hidden rounded-xl border border-border bg-bg-elevated/60 shadow-[0_0_0_1px_rgb(255_116_23/0.08)] transition-colors duration-200 hover:border-accent/45">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2">
          ...
          <ul className="grid gap-4 text-sm">
            {[
              ...
              <li key={k} className="rounded-lg border border-border bg-bg-elevated/60 p-4 shadow-[0_0_0_1px_rgb(255_116_23/0.06)] transition-colors duration-200 hover:border-accent/35">
