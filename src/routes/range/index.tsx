    ...
    <div className="min-h-dvh bg-bg">
      ...
      <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="max-w-3xl">
          <div className="mb-5 flex items-center gap-3"><img src="/brand/vayu-logo.svg" alt="Vāyú Shastr" className="h-8 w-auto" /><span className="text-[11px] font-semibold uppercase tracking-[0.2em] text-green">VYNDI · The range</span></div>
