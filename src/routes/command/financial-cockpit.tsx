    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">A read-only executive projection over editable planning assumptions. Use operational read models for posted inventory and procurement evidence. <span className="text-fg">Where is the money, where is it going, what are we getting back, when do we run out, and what changes the answer?</span></p>
        </div>
        <div className="flex flex-wrap gap-3 text-sm"><Link to="/command/finance-assumptions" className="text-accent hover:text-fg">Edit live assumptions →</Link><Link to="/command/inventory-truth" className="text-accent hover:text-fg">Inventory truth →</Link><Link to="/command/procurement" className="text-accent hover:text-fg">Procurement →</Link></div>
      </div>
