...
function DemoCompany() {
  return <div className="space-y-7">
    <header>
      ...
      <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">A realistic end-to-end company scenario for demonstrating VYNDI without presenting demonstration data as audited company performance. The scenario shows how one business moves from signal to decision, execution, evidence and stakeholder reporting.</p>
