...
import { getAuthoritativeInventory, getAuthoritativeInventoryMovements, getInventoryControlSummary } from "@/lib/inventory-authority";
...
export const Route = createFileRoute("/command/inventory-truth")({
  loader: async () => {
    ...
    return { summary, balances, movements };
  },
  component: InventoryTruth,
});

function InventoryTruth() {
  const { summary, balances, movements } = Route.useLoaderData();
