...
function ProductionJobCards() {
  ...
  return <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 space-y-6">
    <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div><p className="text-[10px] uppercase tracking-[0.22em] text-green">Operations · order handoff</p><h1 className="mt-2 text-4xl font-bold text-accent">Production job cards</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-muted">Every confirmed model order is converted into one controlled production handoff. The card carries the model, quantity, BOM tier and stage-wise component/raw-material requirements; inventory consumption is posted through EPR against the authoritative ledger.</p></div>
